...
export default async function Page({ params : { locale }} : { params : { locale: string }; }) {
  ...
  return (
    <div className="font-[sans-serif] bg-white pb-5">
      <SubHeader title={t('faq')} crumbs={[{ url : "/about", title : "About" }]} />
      <Sidebar />
      <div className="w-full lg:w-4/5 min-h-screen m-auto mt-12 text-black static-page">
        <div className="col-span-2 mt-5">
          <div className="px-4 pb-4 break-words faq-page">
            <Content />
          </div>
        </div>
      </div>
