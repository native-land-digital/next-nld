...
import AboutTech from '@/public/images/pages/how-to-use-tech.webp'
...
Native Land Digital is a registered Canadian not-for-profit organization. We have a majority-Indigenous Board of Directors, representing people who have close ties to land bases, communities, and deep knowledge about Indigenous ways of being and knowing.

The Board of Directors is further informed by an Advisory Council, consisting of a variety of specialists in mapmaking, GIS, relations with Indigenous communities, and more. Together, these two forces help to face and deal with many of complex issues that mapping Indigenous territories involves, such as:
...
<Image src={AboutTech} alt="About the tech" />
