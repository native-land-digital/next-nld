...
<Image src={Tanya} alt="Tanya Ruka" class="w-52 h-auto float-right p-2.5" />
...
<Image src={VictorS} alt="Victor Sauca" class="w-52 h-auto float-left p-2.5" />
...
<Image src={Makayla} alt="Makayla Rawlins" class="w-52 h-auto float-right p-2.5" />
...
<Image src={Emily} alt="Emily Haines" class="w-52 h-auto float-left p-2.5" />
...
<Image src={Racquel} alt="Racquel Banaszak" class="w-52 h-auto float-right p-2.5" />
...
<Image src={Will} alt="Will Gutierrez" class="w-52 h-auto float-left p-2.5" />
...
<Image src={Shauna} alt="Shauna Johnson" class="w-52 h-auto float-right p-2.5" />
...
<Image src={Rudo} alt="Rudo Kemper" class="w-52 h-auto float-left p-2.5" />
...
<Image src={Mesiah} alt="Mesiah Burciaga-Hameed" class="w-52 h-auto float-right p-2.5" />
...
<Image src={Kyle} alt="Kyle Napier" class="w-52 h-auto float-left p-2.5" />
...
<Image src={Moka} alt="Moka Apiti" class="w-52 h-auto float-right p-2.5" />
...
<Image src={Aaron} alt="Aaron Carapella" class="w-52 h-auto float-left p-2.5" />
...
<Image src={Stephanie} alt="Stephanie Pyne" class="w-52 h-auto float-right p-2.5" />
...
<Image src={Leena} alt="Leena Minifie" class="w-52 h-auto float-left p-2.5" />
...
<Image src={Tyler} alt="Tyler McCreary" class="w-52 h-auto float-right p-2.5" />
...
<Image src={JeanLuc} alt="Jean-Luc Fournier" class="w-52 h-auto float-left p-2.5" />
