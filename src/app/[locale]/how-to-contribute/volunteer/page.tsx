...
import ContributeTop from '@/public/images/pages/territory-how.webp'
...
export default async function Page({ params : { locale }} : { params : { locale: string }; }) {
  ...
  return (
    <div className="font-[sans-serif] bg-white pb-5">
      <SubHeader title={t('volunteer')} crumbs={[{ url : "/how-to-contribute", title : "How To Contribute" }]} />
      <div className="grid gap-5 grid-cols-1 md:grid-cols-3 px-5 md:px-0 w-full md:w-2/3 min-h-screen m-auto -mt-12 text-black static-page">
        ...
        <div className="col-span-2 bg-white rounded-t shadow-lg mt-5">
          <div className="w-full max-h-[200px] overflow-hidden rounded-t">
            <Image src={ContributeTop} alt="Volunteer Header Image" className="object-cover object-center rounded-t" />
          </div>
