      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          <ul className="mb-6 flex flex-col gap-1.5">
            ...
            : false }
            {session.user.permissions.indexOf('issues') > -1 ?
              <li>
                <Link prefetch={false} href="/dashboard/issues" className="shadow group relative flex items-center gap-2.5 rounded px-4 py-2 font-medium text-white duration-300 ease-in-out bg-white bg-opacity-20 hover:bg-opacity-30 ">
                  {tDash('issues')}
                </Link>
              </li>
            : false }
