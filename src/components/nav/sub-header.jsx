...
export default async function SubHeader({ title, crumbs = [], verification = false }) {
  ...
  return (
    <div className="bg-cover h-[380px] flex items-center py-6 px-4 lg:px-0" style={{ backgroundImage : "url('https://d75cfcm8x0ifj.cloudfront.net/hero.png')"}}>
      <div className="pt-24 w-full lg:w-2/3 m-auto capitalize break-words">
