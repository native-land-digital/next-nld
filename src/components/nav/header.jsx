  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-white py-4 px-6">
      <div className="flex items-center flex-shrink-0 mr-6 ml-6">
        <Link prefetch={false} href="/"><Image src={Logo} alt="Native Land Digital logo" width="23" height="36" /></Link>
        <Link prefetch={false} href="/"><span className="font-normal text-2xl tracking-tight ml-5 text-slate-600">{t('native-land')}</span></Link>
      </div>
