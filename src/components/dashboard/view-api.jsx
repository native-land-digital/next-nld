  ...
  return (
    <div>
      <div className="w-full py-4 px-2 bg-blue-200 rounded">
        <input type="checkbox" checked={agreement ? true : false}  onChange={(e) => saveAgreement(e.target.checked)}/> <a className="ml-2.5 underline" href="https://victor-gerard-temprano.gitbook.io/native-land-digital-api/data-sovereignty-treaty">{t('data-sov')} ➜</a>
      </div>
