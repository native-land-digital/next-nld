...
function BotChatMessage({ message }) {
  return <div className="rounded-md bg-blue-500 py-2.5 px-3 text-sm ml-2.5">
    {!message || message === "" ? <>{loader()} Thinking...</> : <Markdown>{message}</Markdown>}
  </div>
}
...
const loader = () => {
  return (
    <svg className="inline" width="15" height="15" viewBox="0 0 135 135" xmlns="http://www.w3.org/2000/svg" fill="#fff">
