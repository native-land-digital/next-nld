...
const config = (setMinimized) => {
  return {
    initialMessages: [
      createChatBotMessage(`Welcome! My name is Kōrero. I'm here to help you understand Indigenous land and culture. I can help you create a territory acknowledgement or help you understand more about your own relationship to the land. Where are you from?`)
    ],
    botName : "Kōrero",
    customComponents : {
      header: () => {
