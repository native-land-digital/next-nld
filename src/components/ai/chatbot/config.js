...
const config = {
  initialMessages: [
    createChatBotMessage(`Welcome! I am a trained AI here to help you understand Indigenous land and culture. I can help you create a territory acknowledgement or help you understand more about your own relationship to the land. Would you like help creating a meaningful land acknowledgement for the land you live on?`)
  ],
  botName : "Kōrero",
  customComponents : {
    botAvatar : (props) => {
      return (
        <div className="h-5 w-5 rounded-full mt-2.5">
