...
export default function MainMap({ map, setMap, setSelectedFeature }) {
  ...
  return (
    <>
      <div id="nld-reciprocity-map" className="w-full h-[95%] md:h-full"></div>
      <div className={`absolute top-0 w-screen h-screen bg-black z-999 flex items-center align-center transition-opacity duration-1000 ease-in-out ${loaded ? 'opacity-0 pointer-events-none' : ''}`}>
