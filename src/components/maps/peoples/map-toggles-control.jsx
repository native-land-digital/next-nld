...
import { exportMap } from '@/components/maps/peoples/map-utils';
    ...
    return (
      <div>
        ...
        <div className="mb-48 lg:mb-4 lg:mr-16 absolute right-0 bottom-0 m-4 z-[5] lg:z-10 flex-col flex lg:flex-row gap-4 pointer-events-none">
          <div onClick={() => zoomText()} className="lg:mt-4 rounded-full border nld-text-teal-100 nld-border-teal-100 nld-bg-blue-800 p-2.5 flex items-center cursor-pointer pointer-events-auto hover:bg-sky-800">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="hidden lg:block ml-2">Text Size</div>
          </div>
          ...
          <div onClick={() => toggleColors()} className="lg:mt-4 rounded-full flex items-center border nld-text-teal-100 nld-border-teal-100 nld-bg-blue-800 p-2.5 cursor-pointer pointer-events-auto hover:bg-sky-800">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="hidden lg:block ml-2">Colors</div>
          </div>
          <div onClick={() => toggleLabels()} className="lg:mt-4 rounded-full flex items-center border nld-text-teal-100 nld-border-teal-100 nld-bg-blue-800 p-2.5 cursor-pointer pointer-events-auto hover:bg-sky-800">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="hidden lg:block ml-2">Labels</div>
          </div>
        </div>
      </div>
    )
