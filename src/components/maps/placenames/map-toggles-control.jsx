    ...
    return (
      <div>
        ...
        <div className="mb-48 md:mb-4 md:mr-16 absolute right-0 bottom-0 m-4 z-[5] md:z-10 flex-col flex md:flex-row gap-4 pointer-events-none">
          <div onClick={() => exportMap(map)} className="hidden md:flex md:mt-4 items-center rounded-full border nld-text-teal-100 nld-border-teal-100 nld-bg-blue-800 p-2.5 cursor-pointer pointer-events-auto hover:bg-sky-800">
