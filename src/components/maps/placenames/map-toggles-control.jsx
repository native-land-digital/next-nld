    ...
    return (
      <div>
        ...
        <div className="mb-48 lg:mb-4 lg:mr-16 absolute right-0 bottom-0 m-4 z-[5] lg:z-10 flex-col flex lg:flex-row gap-4 pointer-events-none">
          <div onClick={() => exportMap(map)} className="hidden lg:flex lg:mt-4 items-center rounded-full border nld-text-teal-100 nld-border-teal-100 nld-bg-blue-800 p-2.5 cursor-pointer pointer-events-auto hover:bg-sky-800">
