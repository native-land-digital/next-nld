        ...
        <div className="w-full md:w-80">
          <div className="w-80 m-4 nld-bg-blue-800-10 rounded-full md:rounded-xl p-0 md:p-2.5">
            <div className="hidden md:flex">
              ...
              <p className="ml-2.5 hidden md:block nld-text-sm nld-text-teal-100">{tMaps('search-address-placenames')}</p>
            </div>
            ...
            <AsyncSelect
              ...
              placeholder={
                <div className="flex items-center">
                  ...
                  <div className="ml-2.5">{t('search-placenames')}</div>
                </div>
              }
              onChange={(e) => selectDropdown(e.value, 'placenames')}
              cacheOptions
              defaultOptions={placenameOptions.map(placename => { return { value : placename.id, label : placename.name }})}
