...
import { randomStartingPosition, createSetFeatureCollection, entryQuery, getUniqueFeatures, isMobile } from '@/components/maps/nations/map-utils';
...
export default function MainMap({ allLayers, map, setMap, setSelectedFeatures, currentLayers }) {
  ...
  useEffect(() => {
    ...
    const newMap = new mapboxgl.Map({
      ...
      style: process.env.NEXT_PUBLIC_MAPBOX_STYLE_PEOPLES + "?fresh=true",
      showZoom: false,
      showCompass: false,
